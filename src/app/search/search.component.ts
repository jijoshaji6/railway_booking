...
import { Booking, ISearchTrain, IStation, ResponseModel, TrainAppBookingPassenger } from '../stations';
...
export class SearchComponent implements OnInit {
  ...
  bookingPassengers: TrainAppBookingPassenger = new TrainAppBookingPassenger();

  loggedUserData: any;
  constructor(private activactedRoute: ActivatedRoute, private stationSrv: StationsService, private trainSrv: StationsService) {
